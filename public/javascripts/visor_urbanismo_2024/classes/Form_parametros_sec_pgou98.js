...
class Form_PARAMETROS_SEC_PGOU98 {
  ...
  async createForm() {
    ...
    html =
      ...
      `<div class="div-form">
        ${this.html_TITULO}
        <button  id="printParametersSEC" class="ui-button ui-widget ui-corner-all button-print" title="Imprimir Ficha"><i class="fa fa-print"></i></button> 
        <BR>
        <BR>
        ${this.html_buttons}
        <BR>   
    ...
    document
      .getElementById("printParametersSEC")
