      ...
      if (
        ...
        this.html_CONDICIONES_EDIFICACION = `
            ...
            <tr align="left" bgcolor="white" style='padding:0px;font-size:9.5px;font-family:Arial;color:#000000;height:20px'>
                <td><LABEL id="form_rsd_calif" style='padding:3px;font-size:8pt;font-family:Arial;color:black' align="right">CALIFICACIÓN</LABEL></td>
            ...
            <tr align="left" bgcolor="white" style='padding:0px;font-size:9.5px;font-family:Arial;color:#000000;height:20px'>
                <td><LABEL id="form_rsd_supmin" style='padding:3px;font-size:8pt;font-family:Arial;color:black' align="right">SUPERFICIE MÍNIMA DE PARCELA EN METROS</LABEL></td>
            ...
            <tr align="left" bgcolor="white" style='padding:0px;font-size:9.5px;font-family:Arial;color:#000000;height:20px'>
                <td><LABEL id="form_rsd_anchmin" style='padding:3px;font-size:8pt;font-family:Arial;color:black' align="right">ANCHO MÍNIMO DE PARCELA EN METROS</LABEL></td>
            ...
            <tr align="left" bgcolor="white" style='padding:0px;font-size:9.5px;font-family:Arial;color:#000000;height:20px'>
                ...
                <td><LABEL style='padding:3px;font-size:8pt;font-family:Arial;background-color:white;color:#000000;box-shadow: 2px 2px 2px 2px rgba(0, 0, 0, 0.2);border-style: solid;border-width:0.1pt;border-color:black;width:120px;height:15px'>${this.info_parametros.features[0].properties.vmax}</LABEL></td>
            </tr>
            <tr align="left" bgcolor="white" style='padding:0px;font-size:9.5px;font-family:Arial;color:#000000;height:20px'>
                ...
                <td><LABEL style='padding:3px;font-size:8pt;font-family:Arial;background-color:white;color:#000000;box-shadow: 2px 2px 2px 2px rgba(0, 0, 0, 0.2);border-style: solid;border-width:0.1pt;border-color:black;width:120px;height:15px'>${this.info_parametros.features[0].properties.r}</LABEL></td>
            </tr>
            <tr align="left" bgcolor="white" style='padding:0px;font-size:9.5px;font-family:Arial;color:#000000;height:20px'>
            ...
            <tr align="left" bgcolor="white" style='padding:0px;font-size:9.5px;font-family:Arial;color:#000000;height:20px'>
                ...
                <td><LABEL style='padding:3px;font-size:8pt;font-family:Arial;background-color:white;color:#000000;box-shadow: 2px 2px 2px 2px rgba(0, 0, 0, 0.2);border-style: solid;border-width:0.1pt;border-color:black;width:120px;height:15px'>${this.info_parametros.features[0].properties.ampb}</LABEL></td>
            </tr>
