    ...
    onAdd: function(map){
        ...
        if(this._isHorizontal){
            if(this._isLeftPosition){
                ...
                L.DomUtil.addClass(closeButton, 'fachevron-left');
            }
            else{
                closeButton.style.float = 'left';
                //L.DomUtil.addClass(closeButton, 'fa-circle-chevron-right');
                L.DomUtil.addClass(closeButton, 'fa-solid fa-rectangle-xmark');
            }
        }
        else{
            if(this._isTopPosition){
