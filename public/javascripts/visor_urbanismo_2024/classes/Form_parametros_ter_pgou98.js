/**
 * Clase para gestionar los parámetros de calificación terciaria del PGOU de 1998.
 * @memberof module:Frontend
 */
class Form_PARAMETROS_TER_PGOU98 {
  /**
   * Crea una instancia de Form_PARAMETROS_TER_PGOU98.
   *
  ...
  constructor(ordenacion, tabla, sigduMap) {
    ...
    this.tabla_parametros = "calificacion_terciario_visor";
    this.tabla = tabla;
  ...
  async createForm() {
    ...
    html =
      ...
      `<div class="div-form">
        ${this.html_TITULO}
        <button  id="printParametersTER" class="ui-button ui-widget ui-corner-all button-print" title="Imprimir Ficha"><i class="fa fa-print"></i></button> 
        <BR>
        <BR>
        ${this.html_buttons}
        <BR>   
    ...
    document
      .getElementById("printParametersTER")
