!(function (e) {
  ...
  function (e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mesurar distàncies i àrees">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Mesurar distàncies i àrees</h3> <ul class=tasks> <a href=# class="js-start start">Crear una nova mesura</a> </ul> </div> <div class=js-measuringprompt> <h3>Mesurar distàncies i àrees</h3> <p class=js-starthelp>Comenceu a crear una mesura afegint punts al mapa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancel·lar</a></li> <li><a href=# class="js-finish finish">Acabar la mesura</a></li> </ul> </div> </div> ';
  },
  function (e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Últim punt</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distància</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Area</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function (e, t, r) {
    e.exports =
      '<h3>Point location</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this location</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Esborrar</a></li> </ul> ';
  },
  function (e, t, r) {
    e.exports =
      '<h3>Mesura lineal</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrar en línia</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Esborrar</a></li> </ul> ';
  },
  function (e, t, r) {
    e.exports =
      '<h3>Mesura de l´area</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perímetre</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrar en àrea</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Esborrar</a></li> </ul> ';
  },
]);
